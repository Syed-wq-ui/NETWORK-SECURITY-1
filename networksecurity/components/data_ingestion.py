...
# Use the environment variable, but we'll ensure the code handles connection logic properly
...
class DataIngestion:
    ...
    def export_collection_as_dataframe(self):
        ...
        try:
            ...
            # Use tlsCAFile to fix the SSL handshake error and ensure the URL is parsed correctly
    ...
    def split_data_as_train_test(self, dataframe: pd.DataFrame):
        try:
            ...
            # CREATE DIRECTORY FOR TRAIN FILE
            train_dir_path = os.path.dirname(self.data_ingestion_config.training_file_path)
            os.makedirs(train_dir_path, exist_ok=True)
            
            # CREATE DIRECTORY FOR TEST FILE (This fixes the OSError you had)
